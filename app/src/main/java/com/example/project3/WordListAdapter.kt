...
class WordListAdapter internal constructor(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): WordViewHolder {    //
        val itemView = inflater.inflate(R.layout.recyclerview_layout,               // parent, 3-ий арг. - не знаю, 1-ый аргумент - путь до XML файла с образцом
            parent,
            false)
    ...
    override fun onBindViewHolder(holder: WordViewHolder, position: Int) { //
        val current = words[position]                               // TODO: comment this code
