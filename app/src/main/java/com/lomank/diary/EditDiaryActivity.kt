...
class EditDiaryActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (diary.img != null && diary.img != "") {
            isPhotoExist = true
            Glide.with(this).load(diary.img).placeholder(R.drawable.logo).into(imageView_new_diary)
        }
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (requestCode == choosePhotoRequestCode && resultCode == Activity.RESULT_OK)
        {
            ...
            Glide.with(this).load(uriImage).placeholder(R.drawable.logo).into(imageView_new_diary)
